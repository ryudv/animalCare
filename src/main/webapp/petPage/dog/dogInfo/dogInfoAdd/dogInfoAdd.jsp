...
<head>
    ...
    <link rel="stylesheet" href="dogInfoAdd.css">
...
<body onload="makeCursor()">
    ...
    <div class="mainSection">
	    ...
	    <div class="section1">
	        <div class="hospital">
	        	<a href="hospital/dogHospital.jsp">
	    ...
	    <div class="section2">
	        ...
	        <div class="body">
	        	<a href="body/dogBody.jsp">
	        		<button type="submit" title="기타 반려견 특이사항" onmouseenter="zoomIn()" onmouseleave="zoomOut()"> 
	        			<i class="fas fa-dog"></i><br><h4>BODY</h4>
	        		</button>
	        	</a>       	
	        </div>
    	</div>
