...
<head>
    ...
    <link rel="stylesheet" href="catAddStyle.css">
...
<body onload="makeCursor()">
    ...
    <div class="mainSection">
		...
		<form name='frm' method="post" action="catJoinAction.jsp">
            <table>
                <tr>
                    <td class="subject">NAME</td>
                    <td><input type="text" name="catName" class='input_wh'></td>
                </tr>
                <tr>
                    <td class="subject">GENDER</td>
                    <td>
                        남 <input type="radio" name="catGender" value="남" checked>
                        여 <input type="radio" name="catGender" value="여">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="catType" class='input_wh'></td>
                </tr>
                <tr>
                    <td class="subject">WEIGHT</td>
                    <td><input type="text" name="catWeight" class='input_wh'></td>
                </tr>
                <tr>
